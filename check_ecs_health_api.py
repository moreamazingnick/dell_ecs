...
try:
	...
	response1 = requests.get('https://' + EndpointURL + ':4443/login',auth = HTTPBasicAuth(APIUsername,APIPassword),verify=False)
	...
	response2 = requests.get('https://' + EndpointURL + ':4443/dashboard/zones/localzone',headers={"X-SDS-AUTH-TOKEN":seshtoken},verify=False)
	...
	response3 = requests.get('https://' + EndpointURL + ':4443/logout',headers={"X-SDS-AUTH-TOKEN":seshtoken},verify=False)
except:
...
if intCriticalCount > 0:
	print "CRITICAL - Dell ECS Health: CRITICAL - Nodes(Good/Bad/Maint):{}/{}/{}, Disks(Good/Bad/Maint):{}/{}/{}, Alerts(Crit/Error/Warn):{}/{}/{}".format(numGoodNodes,numBadNodes,numMaintenanceNodes,numGoodDisks,numBadDisks,numMaintenanceDisks,alertsNumUnackCritical,alertsNumUnackError,alertsNumUnackWarning)
	sys.exit(2)

if intWarningCount > 0:
        print "WARNING - Dell ECS Health: DEGRADED - Nodes(Good/Bad/Maint):{}/{}/{}, Disks(Good/Bad/Maint):{}/{}/{}, Alerts(Crit/Error/Warn):{}/{}/{}".format(numGoodNodes,numBadNodes,numMaintenanceNodes,numGoodDisks,numBadDisks,numMaintenanceDisks,alertsNumUnackCritical,alertsNumUnackError,alertsNumUnackWarning)
        sys.exit(1)

if intCriticalCount == 0 and intWarningCount == 0:
	print "OK - Dell ECS Health: HEALTHY - Nodes(Good/Bad/Maint):{}/{}/{}, Disks(Good/Bad/Maint):{}/{}/{}, Alerts(Crit/Error/Warn):{}/{}/{}".format(numGoodNodes,numBadNodes,numMaintenanceNodes,numGoodDisks,numBadDisks,numMaintenanceDisks,alertsNumUnackCritical,alertsNumUnackError,alertsNumUnackWarning)
        sys.exit(0)
